  ...
  return (
    <Box>
        ...
        {/*
            ...
            Button to show Summission Modal.
        */}
        <Button 
            variant="contained" 
            sx={{
        ...
        >   
            ...
            <Fade in={OPEN}>
                ...
                <Box sx={{
                    ...
                    <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", px: 2, marginBottom: "25px" }}>
                        <Typography id="transition-modal-title" variant="h5" component="h5" sx={{ color: "general.main" }}>
                            Upload your answer
                        </Typography>
                        <CloseIcon sx={{width: "30px", height: "30px", color: "general.main",'&:hover': { cursor: 'pointer', color: "glass.main" } }} onClick={handle_close}/>
                    </Box>
...

                        {
                            ...
                            FILES ? (
                                ...
                                <Box sx={{ 
                                    ...
                                    <Box sx={{ display: "flex", flexDirection: "rows", alignItems: "center", gap: 2,}}>
                                        <SourceIcon sx={{ height: 40, width: 40, color: "rgba(0, 0, 0, 0.5)" }} />
                                        <Typography id="transition-modal-title" variant="h6" component="h6" 
                                        sx={{ color: "rgba(0, 0, 0, 0.5)", fontSize: "16px"}}>
                                            {FILES.name}
                                        </Typography>
                                    </Box>

                                    {/* Div that contains the status of the uploaded file*/}
                                    <Box sx={{ display: "flex", flexDirection: "rows", alignItems: "center", gap: 1}}>
                                        <Typography id="transition-modal-title" variant="h6" component="h6" 
                                        sx={{ color: "rgba(0, 0, 0, 0.5)", fontSize: "16px", overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap'}}>
                                            Uploaded
                                        </Typography>
                                        <PendingActionsIcon sx={{ height: 25, width: 25, color: "rgba(0, 0, 0, 0.5)", marginBottom: "7px" }} />
                            ...
                            (
                                ...
                                <Box sx={{ 
                                    ...
                                    <Typography id="transition-modal-title" variant="h6" component="h6" sx={{ color: "rgba(0, 0, 0, 0.3)", fontSize: "18px" }}>
                                        Drag and Drop Here
                                    </Typography>    
                                </Box>
                            )
                    ...
                    <Box sx={{display: 'flex', gap: 10, marginBottom: "20px", flexDirection: "rows", justifyContent: "center", alignItems: "center",}}>
                        ...
                        <label htmlFor="icon-button-file">
                            ...
                            <input type="file" id="icon-button-file" style={{ display: 'none' }} onChange={handleFileInputChange}/>
                        </label>
